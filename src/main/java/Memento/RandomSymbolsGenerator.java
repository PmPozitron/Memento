...
public class RandomSymbolsGenerator {
    ...
    public final static String CYRILLIC_LOWER_CASE = "абвгдеёжзийклмнопрстуфхцчшщъыьэюя";
    public final static String CYRYLLIC_UPPER_CASE = "АБВГДЕЁЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯ";
    public final static String CYRYLLIC_LITE_UPPER_CASE = "АБВГДЕЖЗИКЛМНОПРСТУФХЦЧШЫЪЭЮЯ";
